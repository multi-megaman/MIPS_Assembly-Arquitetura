...
parse_string: #funï¿½ï¿½o que separa a string informada em paramentros ($a0, $a1, $a2, $a3) e pula diretamente para a funï¿½ï¿½o informada na String
	...
	parse_string_achou:
		...
		parse_string_achou0:
			addi $t0, $t0, 1 #adiciona 1 ao endereco atual para pegar o primeiro elemento da String e nï¿½o o simbolo "-"
	...
	parse_string_fim: #codigo que vai direcionar para onde o programa vai :)
		...
		parse_string_cardapio:
			...
			parse_string_cardapio_ad: #100%
				...
				j super_hiper_end #finaliza a função do parser
		...
		parse_string_arquivo:
			...
			parse_string_arquivo_recarregar: #100%
				jal recarregar #pula para a função de tirar o conteudo do arquivo e colocar na memoria
				j super_hiper_end #finaliza o parser
			parse_string_arquivo_formatar: #100%
				jal formatar #pular para a função que apaga todos os dados do arquivo
				j super_hiper_end #finaliza o parser
